...
var airspyhf_lib_version: *const fn (lib_version: [*c]airspyhf_lib_version_t) void = undefined;
var airspyhf_list_devices: *const fn (serials: [*c]u64, count: c_int) c_int = undefined;
var airspyhf_open: *const fn (device: [*c]?*airspyhf_device_t) c_int = undefined;
var airspyhf_open_sn: *const fn (device: [*c]?*airspyhf_device_t, serial_number: u64) c_int = undefined;
var airspyhf_open_fd: *const fn (device: [*c]?*airspyhf_device_t, fd: c_int) c_int = undefined;
var airspyhf_close: *const fn (device: ?*airspyhf_device_t) c_int = undefined;
var airspyhf_get_output_size: *const fn (device: ?*airspyhf_device_t) c_int = undefined;
var airspyhf_start: *const fn (device: ?*airspyhf_device_t, callback: airspyhf_sample_block_cb_fn, ctx: ?*anyopaque) c_int = undefined;
var airspyhf_stop: *const fn (device: ?*airspyhf_device_t) c_int = undefined;
var airspyhf_is_streaming: *const fn (device: ?*airspyhf_device_t) c_int = undefined;
var airspyhf_is_low_if: *const fn (device: ?*airspyhf_device_t) c_int = undefined;
var airspyhf_set_freq: *const fn (device: ?*airspyhf_device_t, freq_hz: u32) c_int = undefined;
var airspyhf_set_lib_dsp: *const fn (device: ?*airspyhf_device_t, flag: u8) c_int = undefined;
var airspyhf_get_samplerates: *const fn (device: ?*airspyhf_device_t, buffer: [*c]u32, len: u32) c_int = undefined;
var airspyhf_set_samplerate: *const fn (device: ?*airspyhf_device_t, samplerate: u32) c_int = undefined;
var airspyhf_get_calibration: *const fn (device: ?*airspyhf_device_t, ppb: [*c]i32) c_int = undefined;
var airspyhf_set_calibration: *const fn (device: ?*airspyhf_device_t, ppb: i32) c_int = undefined;
var airspyhf_set_optimal_iq_correction_point: *const fn (device: ?*airspyhf_device_t, w: f32) c_int = undefined;
var airspyhf_iq_balancer_configure: *const fn (device: ?*airspyhf_device_t, buffers_to_skip: c_int, fft_integration: c_int, fft_overlap: c_int, correlation_integration: c_int) c_int = undefined;
var airspyhf_flash_calibration: *const fn (device: ?*airspyhf_device_t) c_int = undefined;
var airspyhf_board_partid_serialno_read: *const fn (device: ?*airspyhf_device_t, read_partid_serialno: [*c]airspyhf_read_partid_serialno_t) c_int = undefined;
var airspyhf_version_string_read: *const fn (device: ?*airspyhf_device_t, version: [*c]u8, length: u8) c_int = undefined;
var airspyhf_set_user_output: *const fn (device: ?*airspyhf_device_t, pin: airspyhf_user_output_t, value: airspyhf_user_output_state_t) c_int = undefined;
var airspyhf_set_hf_agc: *const fn (device: ?*airspyhf_device_t, flag: u8) c_int = undefined;
var airspyhf_set_hf_agc_threshold: *const fn (device: ?*airspyhf_device_t, flag: u8) c_int = undefined;
var airspyhf_set_hf_att: *const fn (device: ?*airspyhf_device_t, value: u8) c_int = undefined;
var airspyhf_set_hf_lna: *const fn (device: ?*airspyhf_device_t, flag: u8) c_int = undefined;
