...
var rtlsdr_set_direct_sampling: *const fn (dev: ?*rtlsdr_dev_t, on: c_int) callconv(.C) c_int = undefined;
var rtlsdr_set_tuner_gain_mode: *const fn (dev: ?*rtlsdr_dev_t, manual: c_int) callconv(.C) c_int = undefined;
var rtlsdr_set_agc_mode: *const fn (dev: ?*rtlsdr_dev_t, on: c_int) callconv(.C) c_int = undefined;
var rtlsdr_set_tuner_gain: *const fn (dev: ?*rtlsdr_dev_t, gain: c_int) callconv(.C) c_int = undefined;
var rtlsdr_set_freq_correction: *const fn (dev: ?*rtlsdr_dev_t, ppm: c_int) callconv(.C) c_int = undefined;
var rtlsdr_set_center_freq: *const fn (dev: ?*rtlsdr_dev_t, freq: u32) callconv(.C) c_int = undefined;
var rtlsdr_get_center_freq: *const fn (dev: ?*rtlsdr_dev_t) callconv(.C) u32 = undefined;
var rtlsdr_set_sample_rate: *const fn (dev: ?*rtlsdr_dev_t, rate: u32) callconv(.C) c_int = undefined;
var rtlsdr_get_sample_rate: *const fn (dev: ?*rtlsdr_dev_t) callconv(.C) u32 = undefined;
var rtlsdr_set_tuner_bandwidth: *const fn (dev: ?*rtlsdr_dev_t, bw: u32) callconv(.C) c_int = undefined;
var rtlsdr_reset_buffer: *const fn (dev: ?*rtlsdr_dev_t) callconv(.C) c_int = undefined;
var rtlsdr_read_sync: *const fn (dev: ?*rtlsdr_dev_t, buf: ?*anyopaque, len: c_int, n_read: [*c]c_int) callconv(.C) c_int = undefined;
var rtlsdr_close: *const fn (dev: ?*rtlsdr_dev_t) callconv(.C) c_int = undefined;
