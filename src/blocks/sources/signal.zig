...
test "SignalSource" {
    // Cosine frequency 50, sample rate 1000, ampltiude 1.00, offset 0.00, phase 0.0000
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.cosine_frequency_50_rate_1000_ampltiude_1_offset_0_phase_0});
    }
    ...
    // Cosine frequency 100, sample rate 1000, ampltiude 2.50, offset -0.50, phase 0.7854
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.cosine_frequency_100_rate_1000_ampltiude_2_5_offset_neg_0_50_phase_0_7854});
    }
    ...
    // Sine frequency 50, sample rate 1000, ampltiude 1.00, offset 0.00, phase 0.0000
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.sine_frequency_50_rate_1000_ampltiude_1_offset_0_phase_0});
    }
    ...
    // Sine frequency 100, sample rate 1000, ampltiude 2.50, offset -0.50, phase 0.7854
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.sine_frequency_100_rate_1000_ampltiude_2_5_offset_neg_0_50_phase_0_7854});
    }
    ...
    // Square frequency 50, sample rate 1000, ampltiude 1.00, offset 0.00, phase 0.0000
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.square_frequency_50_rate_1000_ampltiude_1_offset_0_phase_0});
    }
    ...
    // Square frequency 100, sample rate 1000, ampltiude 2.50, offset -0.50, phase 0.7854
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.square_frequency_100_rate_1000_ampltiude_2_5_offset_neg_0_50_phase_0_7854});
    }
    ...
    // Triangle frequency 50, sample rate 1000, ampltiude 1.00, offset 0.00, phase 0.0000
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.triangle_frequency_50_rate_1000_ampltiude_1_offset_0_phase_0});
    }
    ...
    // Triangle frequency 100, sample rate 1000, ampltiude 2.50, offset -0.50, phase 0.7854
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.triangle_frequency_100_rate_1000_ampltiude_2_5_offset_neg_0_50_phase_0_7854});
    }
    ...
    // Sawtooth frequency 50, sample rate 1000, ampltiude 1.00, offset 0.00, phase 0.0000
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.sawtooth_frequency_50_rate_1000_ampltiude_1_offset_0_phase_0});
    }
    ...
    // Sawtooth frequency 100, sample rate 1000, ampltiude 2.50, offset -0.50, phase 0.7854
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.sawtooth_frequency_100_rate_1000_ampltiude_2_5_offset_neg_0_50_phase_0_7854});
    }
    ...
    // Constant frequency 50, sample rate 1000, ampltiude 1.00, offset 0.00, phase 0.0000
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.constant_frequency_50_rate_1000_ampltiude_1_offset_0_phase_0});
    }
    ...
    // Constant frequency 100, sample rate 1000, ampltiude 2.50, offset -0.50, phase 0.7854
    {
        ...
        var tester = try BlockTester(&[0]type{}, &[1]type{f32}).init(&block.block, 1.5e-5);
        try tester.checkSource(.{&vectors.constant_frequency_100_rate_1000_ampltiude_2_5_offset_neg_0_50_phase_0_7854});
    }
}
